...
export const dict = {
  ...
  'pwa.installPrompt.description': 'Install LinkCode for quicker access',
  'pwa.installPrompt.action': 'Install',
  'pwa.installPrompt.dismiss': 'Dismiss',
  'pwa.installPrompt.started': 'Install started',
  'pwa.installPrompt.installed': 'LinkCode installed',
  ...
  'sessions.sidebar.footer.actions.aboutOpenChamber': 'About LinkCode',
  ...
  'contextPanel.browser.trustNotice': 'Pages opened here run with full access to LinkCode — needed for inspect and screenshots. Only open sites you trust: a malicious page could read your data or act on your behalf.',
  ...
  'header.services.shutdownDev': 'Stop LinkCode',
  ...
  'aboutDialog.openChamberVersionLabel': 'LinkCode version {version}',
  ...
  'aboutDialog.diagnosticsDescription': 'Includes LinkCode state, OpenCode health, directories, and projects.',
  ...
  'helpDialog.description': 'Use these keyboard shortcuts to navigate LinkCode efficiently',
  ...
  'header.actions.openAppMenu': 'LinkCode menu',
  'header.actions.openAppMenuAria': 'Open LinkCode menu',
  ...
  'sessionAuth.locked.unlockTitle': 'Unlock LinkCode',
  ...
  'desktopHostSwitcher.description': 'Switch between Local and remote LinkCode servers',
  ...
  'multiRun.window.description': 'LinkCode Multi-Run window.',
  ...
  'onboarding.chooser.title': 'Welcome to LinkCode',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'If LinkCode does not detect OpenCode automatically, set the binary path below.',
  'onboarding.localSetup.intro': 'OpenCode is the heart of LinkCode — install it to get started.',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Saves to LinkCode settings and reloads OpenCode configuration.',
  ...
  'onboarding.remoteConnection.description': 'Enter the address of an LinkCode server to connect to.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'Suggestions: Verify the URL points to an LinkCode server, or contact the server administrator.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': 'This instance is running a different LinkCode version. You can connect, but update both apps if something does not work.',
  'onboarding.remoteConnection.probe.incompatibleMessage': 'Server is running LinkCode but is not compatible with this app version. Update LinkCode on the server, then try again.',
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'Server responded but is not running LinkCode. Verify the address points to an LinkCode server.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': 'The server at "{host}" is not running LinkCode. Verify the address points to an LinkCode server.',
  'onboarding.desktopRecovery.remoteIncompatible.title': 'Server Update Required',
  'onboarding.desktopRecovery.remoteIncompatible.description': 'The LinkCode server at "{host}" is not compatible with this app version. Update LinkCode on the server, then try again.',
  ...
  'startup.initRecovery.description': 'LinkCode could not finish initialization. Check that the server is running, then retry.',
  ...
  'updateDialog.header.updating': 'Updating LinkCode...',
  ...
  'opencodeUpdate.toast.upgrading.description': 'Keep LinkCode open.',
  ...
  'openChamberLogo.aria.logo': 'LinkCode logo',
  ...
  'assistantStatus.waitingPermission': 'Waiting for permission',
  'assistantStatus.tool.read': 'Reading file',
  'assistantStatus.tool.write': 'Writing file',
  ...
  'assistantStatus.tool.list': 'Listing directory',
  'assistantStatus.tool.task': 'Delegating task',
  'assistantStatus.tool.webfetch': 'Fetching URL',
  'assistantStatus.tool.websearch': 'Searching web',
  'assistantStatus.tool.codesearch': 'Web code search',
  'assistantStatus.tool.todowrite': 'Updating todos',
  'assistantStatus.tool.todoread': 'Reading todos',
  'assistantStatus.tool.skill': 'Learning skill',
  'assistantStatus.tool.question': 'Asking question',
  'assistantStatus.tool.planEnter': 'Switching to planning',
  'assistantStatus.tool.planExit': 'Switching to building',
  'assistantStatus.usingTool': 'Using {toolName}',
  'assistantStatus.working.0': 'Working',
  'assistantStatus.working.1': 'Processing',
  'assistantStatus.working.2': 'Preparing',
  'assistantStatus.working.3': 'Warming up',
  'assistantStatus.working.4': 'Gears turning',
  'assistantStatus.working.5': 'Computing',
  'assistantStatus.working.6': 'Calculating',
  'assistantStatus.working.7': 'Analyzing',
  'assistantStatus.working.8': 'Wheels spinning',
  'assistantStatus.working.9': 'Calibrating',
  'assistantStatus.working.10': 'Synthesizing',
  'assistantStatus.working.11': 'Connecting dots',
  'assistantStatus.working.12': 'Inspecting logic',
  'assistantStatus.working.13': 'Weighing options',
