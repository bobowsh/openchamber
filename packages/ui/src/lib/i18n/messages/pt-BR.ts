...
export const dict: Record<I18nKey, string> = {
 ...settingsDict,
  ...
  "pwa.installPrompt.description": "Instale o LinkCode para acessar mais rápido",
  "pwa.installPrompt.action": "Instalar",
  "pwa.installPrompt.dismiss": "Dispensar",
  "pwa.installPrompt.started": "Instalação iniciada",
  "pwa.installPrompt.installed": "LinkCode instalado",
  ...
  "sessions.sidebar.footer.actions.aboutOpenChamber": "Sobre o LinkCode",
  ...
  "contextPanel.browser.trustNotice": "As páginas abertas aqui são executadas com acesso total ao LinkCode — necessário para inspeção e capturas de tela. Abra apenas sites confiáveis: uma página maliciosa pode ler seus dados ou agir em seu nome.",
  ...
  "header.services.shutdownDev": "Parar LinkCode",
  ...
  "aboutDialog.openChamberVersionLabel": "Versão do LinkCode {version}",
  ...
  "aboutDialog.diagnosticsDescription": "Inclui o estado do LinkCode, a integridade do OpenCode, diretórios e projetos.",
  ...
  "helpDialog.description": "Use estes atalhos de teclado para navegar pelo LinkCode com eficiência",
  ...
  "header.actions.openAppMenu": "Menu do LinkCode",
  "header.actions.openAppMenuAria": "Abrir menu do LinkCode",
  ...
  "desktopHostSwitcher.description": "Alterne entre Local e o servidor remoto do LinkCode",
  ...
  "multiRun.window.description": "Janela do LinkCode Multi-Run.",
  ...
  "onboarding.chooser.title": "Boas-vindas ao LinkCode",
  ...
  "onboarding.localSetup.windows.stepSetBinaryPath": "Se o LinkCode não detectar o OpenCode automaticamente, defina o caminho do executável a seguir.",
  "onboarding.localSetup.intro": "OpenCode é o coração do LinkCode. Instale-o para começar.",
  ...
  "onboarding.localSetup.helper.saveAndReload": "Salve nas configurações do LinkCode e recarregue configurações do OpenCode.",
  ...
  "onboarding.remoteConnection.description": "Digite o endereço de um servidor do LinkCode para conectar.",
  ...
  "onboarding.remoteConnection.status.suggestionsWrongService": "Sugestões: verifique se a URL aponta para um servidor LinkCode ou entre em contato com o administrador do servidor.",
  ...
  "onboarding.remoteConnection.probe.updateRecommendedMessage": "Esta instância está executando uma versão diferente do LinkCode. Você pode se conectar, mas atualize os dois apps se algo não funcionar.",
  "onboarding.remoteConnection.probe.incompatibleMessage": "O servidor está executando LinkCode, mas não é compatível com esta versão do app. Atualize o LinkCode no servidor e tente novamente.",
  "onboarding.remoteConnection.probe.wrongServiceMessage": "O servidor respondeu, mas não está executando LinkCode. Verifique se o endereço aponta para um servidor LinkCode.",
  ...
  "onboarding.desktopRecovery.incompatibleServer.description": "O servidor em \"{host}\" não está executando LinkCode. Verifique se o endereço aponta para um servidor LinkCode.",
  "onboarding.desktopRecovery.remoteIncompatible.title": "Atualização do servidor necessária",
  "onboarding.desktopRecovery.remoteIncompatible.description": "O servidor LinkCode em \"{host}\" não é compatível com esta versão do app. Atualize o LinkCode no servidor e tente novamente.",
  ...
  "startup.initRecovery.description": "O LinkCode não conseguiu concluir a inicialização. Verifique se o servidor está em execução e tente novamente.",
  ...
  "updateDialog.header.updating": "Atualizando LinkCode...",
  ...
  "opencodeUpdate.toast.upgrading.description": "Mantenha o LinkCode aberto.",
  ...
  "openChamberLogo.aria.logo": "Logo do LinkCode",
