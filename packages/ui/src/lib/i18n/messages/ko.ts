...
export const dict: Record<I18nKey, string> = {
  ...
  'pwa.installPrompt.description': '더 빠르게 접근하려면 LinkCode를 설치하세요',
  'pwa.installPrompt.action': '설치',
  'pwa.installPrompt.dismiss': '닫기',
  'pwa.installPrompt.started': '설치가 시작되었습니다',
  'pwa.installPrompt.installed': 'LinkCode가 설치되었습니다',
  ...
  'sessions.sidebar.footer.actions.aboutOpenChamber': 'LinkCode 정보',
  ...
  'contextPanel.browser.trustNotice': '여기서 여는 페이지는 LinkCode에 대한 전체 액세스 권한으로 실행됩니다 — 검사와 스크린샷에 필요합니다. 신뢰하는 사이트만 여세요: 악성 페이지가 데이터를 읽거나 사용자를 대신해 동작할 수 있습니다.',
  ...
  'header.services.shutdownDev': 'LinkCode 종료',
  ...
  'aboutDialog.openChamberVersionLabel': 'LinkCode 버전 {version}',
  ...
  'aboutDialog.diagnosticsDescription': 'LinkCode 상태, OpenCode 상태, 디렉터리 및 프로젝트를 포함합니다.',
  ...
  'helpDialog.description': '이 단축키로 LinkCode를 빠르게 탐색하세요',
  ...
  'header.actions.openAppMenu': 'LinkCode 메뉴',
  'header.actions.openAppMenuAria': 'LinkCode 메뉴 열기',
  ...
  'sessionAuth.locked.unlockTitle': 'LinkCode 잠금 해제',
  ...
  'desktopHostSwitcher.description': '로컬과 원격 LinkCode 서버 간에 전환합니다',
  ...
  'multiRun.window.description': 'LinkCode 멀티런 창.',
  ...
  'onboarding.chooser.title': 'LinkCode에 오신 것을 환영합니다',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'LinkCode가 OpenCode를 자동으로 찾지 못하면 아래에 바이너리 경로를 설정하세요.',
  'onboarding.localSetup.intro': 'OpenCode는 LinkCode의 심장입니다. 먼저 설치하고 시작하세요.',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'LinkCode 설정에 저장하고 OpenCode 구성을 다시 로드합니다.',
  ...
  'onboarding.remoteConnection.description': '연결할 LinkCode 서버 주소를 입력하세요.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'URL이 LinkCode 서버를 가리키는지 확인하거나 서버 관리자에게 문의하세요.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': '이 인스턴스는 다른 LinkCode 버전을 실행 중입니다. 연결할 수 있지만 문제가 있으면 양쪽 앱을 업데이트하세요.',
  'onboarding.remoteConnection.probe.incompatibleMessage': '서버에서 LinkCode가 실행 중이지만 이 앱 버전과 호환되지 않습니다. 서버의 LinkCode를 업데이트한 후 다시 시도하세요.',
  'onboarding.remoteConnection.probe.wrongServiceMessage': '서버가 응답했지만 LinkCode가 실행 중이 아닙니다. 주소가 LinkCode 서버를 가리키는지 확인하세요.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': '"{host}"의 서버에서 LinkCode가 실행 중이 아닙니다. 주소가 LinkCode 서버를 가리키는지 확인하세요.',
  'onboarding.desktopRecovery.remoteIncompatible.title': '서버 업데이트 필요',
  'onboarding.desktopRecovery.remoteIncompatible.description': '"{host}"의 LinkCode 서버가 이 앱 버전과 호환되지 않습니다. 서버의 LinkCode를 업데이트한 후 다시 시도하세요.',
  ...
  'startup.initRecovery.description': 'LinkCode 초기화를 완료할 수 없습니다. 서버가 실행 중인지 확인한 뒤 다시 시도하세요.',
  ...
  'updateDialog.header.updating': 'LinkCode 업데이트 중…',
  ...
  'opencodeUpdate.toast.upgrading.description': 'LinkCode를 열어 두세요.',
  ...
  'openChamberLogo.aria.logo': 'LinkCode 로고',
