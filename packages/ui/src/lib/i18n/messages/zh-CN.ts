...
export const dict: Record<I18nKey, string> = {
  ...
  'pwa.installPrompt.description': '安装 LinkCode 以便更快访问',
  'pwa.installPrompt.action': '安装',
  'pwa.installPrompt.dismiss': '忽略',
  'pwa.installPrompt.started': '已开始安装',
  'pwa.installPrompt.installed': 'LinkCode 已安装',
  ...
  'sessions.sidebar.footer.actions.aboutOpenChamber': '关于 LinkCode',
  ...
  'contextPanel.mode.stagedDiff': '暂存差异',
  ...
  'contextPanel.browser.trustNotice': '在此打开的页面以对 LinkCode 的完全访问权限运行 — 检查和截图需要此权限。仅打开你信任的站点：恶意页面可能读取你的数据或以你的身份执行操作。',
  ...
  'header.services.shutdownDev': '停止 LinkCode',
  ...
  'directoryExplorerDialog.actions.openInFinder': '浏览文件夹',
  ...
  'aboutDialog.openChamberVersionLabel': 'LinkCode 版本 {version}',
  ...
  'aboutDialog.diagnosticsDescription': '包含 LinkCode 状态、OpenCode 健康信息、目录和项目。',
  ...
  'helpDialog.description': '使用这些快捷键可更高效地导航 LinkCode',
  ...
  'header.actions.openAppMenu': 'LinkCode 菜单',
  'header.actions.openAppMenuAria': '打开 LinkCode 菜单',
  ...
  'sessionAuth.locked.unlockTitle': '解锁 LinkCode',
  ...
  'desktopHostSwitcher.description': '在 Local 与远程 LinkCode 服务器之间切换',
  ...
  'multiRun.window.description': 'LinkCode 多运行窗口。',
  ...
  'onboarding.chooser.title': '欢迎使用 LinkCode',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': '如果 LinkCode 未自动检测到 OpenCode，请在下方设置可执行文件路径。',
  'onboarding.localSetup.intro': 'OpenCode 是 LinkCode 的核心，先安装它即可开始。',
  ...
  'onboarding.localSetup.helper.saveAndReload': '将保存到 LinkCode 设置并重新加载 OpenCode 配置。',
  ...
  'onboarding.remoteConnection.description': '输入要连接的 LinkCode 服务器地址。',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': '建议：确认 URL 指向 LinkCode 服务器，或联系服务器管理员。',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': '此实例正在运行不同版本的 LinkCode。你可以连接；如果功能异常，请更新两端应用。',
  'onboarding.remoteConnection.probe.incompatibleMessage': '服务器正在运行 LinkCode，但与此应用版本不兼容。请更新服务器上的 LinkCode 后重试。',
  'onboarding.remoteConnection.probe.wrongServiceMessage': '服务器有响应，但未运行 LinkCode。请确认地址是否指向 LinkCode 服务器。',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': '“{host}” 上的服务器未运行 LinkCode。请确认地址是否指向 LinkCode 服务器。',
  'onboarding.desktopRecovery.remoteIncompatible.title': '需要更新服务器',
  'onboarding.desktopRecovery.remoteIncompatible.description': '“{host}” 上的 LinkCode 服务器与此应用版本不兼容。请更新服务器上的 LinkCode 后重试。',
  ...
  'startup.initRecovery.description': 'LinkCode 未能完成初始化。请检查服务器是否正在运行，然后重试。',
  ...
  'updateDialog.header.updating': '正在更新 LinkCode...',
  ...
  'opencodeUpdate.toast.upgrading.description': '请保持 LinkCode 打开。',
  ...
  'openChamberLogo.aria.logo': 'LinkCode 标志',
  ...
  'contextFileOpen.failure.tooLarge': '文件过大无法打开（超过 {count} 行）',
  ...
  'assistantStatus.thinking': '思考中',
  'assistantStatus.composing': '撰写中',
  'assistantStatus.editingFile': '编辑文件',
  'assistantStatus.editingFiles': '编辑多个文件',
  'assistantStatus.waitingPermission': '等待授权',
  'assistantStatus.tool.read': '读取文件',
  'assistantStatus.tool.write': '写入文件',
  'assistantStatus.tool.edit': '编辑文件',
  'assistantStatus.tool.multiedit': '编辑多个文件',
  'assistantStatus.tool.applyPatch': '应用补丁',
  'assistantStatus.tool.bash': '执行命令',
  'assistantStatus.tool.grep': '搜索内容',
  'assistantStatus.tool.glob': '查找文件',
  'assistantStatus.tool.list': '列出目录',
  'assistantStatus.tool.task': '委派任务',
  'assistantStatus.tool.webfetch': '获取 URL',
  'assistantStatus.tool.websearch': '搜索网页',
  'assistantStatus.tool.codesearch': '搜索代码',
  'assistantStatus.tool.todowrite': '更新待办',
  'assistantStatus.tool.todoread': '读取待办',
  'assistantStatus.tool.skill': '加载技能',
  'assistantStatus.tool.question': '提问',
  'assistantStatus.tool.planEnter': '切换计划',
  'assistantStatus.tool.planExit': '切换开发',
  'assistantStatus.usingTool': '使用 {toolName}',
  'assistantStatus.working.0': '工作中',
  'assistantStatus.working.1': '处理中',
  'assistantStatus.working.2': '准备中',
  'assistantStatus.working.3': '预热中',
  'assistantStatus.working.4': '齿轮转动',
  'assistantStatus.working.5': '计算中',
  'assistantStatus.working.6': '计算中',
  'assistantStatus.working.7': '分析中',
  'assistantStatus.working.8': '运转中',
  'assistantStatus.working.9': '校准中',
  'assistantStatus.working.10': '综合中',
  'assistantStatus.working.11': '关联中',
  'assistantStatus.working.12': '检查中',
  'assistantStatus.working.13': '权衡中',
  ...
  'tool.planMode': '计划模式',
  'tool.buildMode': '构建模式',
  'tool.structuredOutput': '结构化输出',
  'tool.webfetch': '获取 URL',
  'tool.websearch': '网页搜索',
