export const settingsDict = {
  ...
  'settings.window.description': 'LinkCode settings window.',
  ...
  'settings.remoteInstances.direct.title': 'Other LinkCode servers',
  'settings.remoteInstances.direct.description': 'Add another LinkCode server by URL. Use this when the server is already running and you have a connection token.',
  ...
  'settings.remoteInstances.direct.import.description': 'Paste a connection link from another LinkCode server.',
  ...
  'settings.remoteInstances.direct.error.invalidConnectLink': 'Invalid LinkCode connection link.',
  ...
  'settings.remoteInstances.clientAuth.description': 'Create a secure link or token so LinkCode Desktop can connect to this server.',
  ...
  'settings.remoteInstances.page.field.modeHint': 'Choose whether LinkCode should start the server for you, or connect to one that is already running.',
  ...
  'settings.openchamber.about.title': 'About LinkCode',
  ...
  'settings.skills.catalog.add.descriptionPrefix': 'Add a Git repository as a new catalog source. LinkCode will scan it for folders containing',
  ...
  'settings.openchamber.desktopNetwork.field.launchAtLoginAria': 'Start LinkCode at login',
  'settings.openchamber.desktopNetwork.field.launchAtLogin': 'Start LinkCode when you log in',
  ...
  'settings.openchamber.desktopPassword.field.passwordDescription': 'LinkCode asks after restart, then when the login session expires: after 12 hours, or 7 days with Trust this device. Leave empty to disable login.',
  ...
  'settings.remoteInstances.page.description': 'Connect to another machine over SSH and open LinkCode there.',
  ...
  'settings.remoteInstances.page.section.remoteServer': 'LinkCode on the remote machine',
  'settings.remoteInstances.page.section.remoteServerDescription': 'Choose how LinkCode should run after SSH connects.',
  'settings.remoteInstances.page.section.mainTunnel': 'Local access',
  'settings.remoteInstances.page.section.mainTunnelDescription': 'Choose the local address used to open this remote LinkCode server.',
  'settings.remoteInstances.page.section.authentication': 'Authentication',
  'settings.remoteInstances.page.section.authenticationDescription': 'Optional credentials for SSH and the remote LinkCode UI.',
  ...
  'settings.remoteInstances.page.field.installMethodHint': 'How LinkCode should be placed on the remote machine when this app starts it for you.',
  ...
  'settings.remoteInstances.page.phase.installingOpenChamber': 'Installing LinkCode',
  'settings.remoteInstances.page.phase.updatingOpenChamber': 'Updating LinkCode',
  ...
  'settings.providers.page.auth.apiKeyTooltip': 'Keys are sent directly to OpenCode and never stored by LinkCode.',
  ...
  'settings.github.page.flow.title': 'Authorize LinkCode',
  ...
  'settings.github.page.ghCli.fallbackDescription': 'Available as fallback if LinkCode auth is removed',
  ...
  'settings.notifications.page.testNotification.body': 'This is a test notification from LinkCode.',
  ...
  'settings.magicPrompts.page.group.sessionFusion.description': '用于将 multi-run 输出合并为一个最终答案的提示词：可见用户消息 + 结果前的隐藏说明。',
