...
export const dict: Record<I18nKey, string> = {
  ...
  'pwa.installPrompt.description': 'Zainstaluj LinkCode, aby mieć szybszy dostęp',
  'pwa.installPrompt.action': 'Zainstaluj',
  'pwa.installPrompt.dismiss': 'Odrzuć',
  'pwa.installPrompt.started': 'Instalacja rozpoczęta',
  'pwa.installPrompt.installed': 'LinkCode został zainstalowany',
  ...
  'sessions.sidebar.footer.actions.aboutOpenChamber': 'O LinkCode',
  ...
  'multiRun.window.description': 'Okno wielokrotnego uruchomienia LinkCode.',
  ...
  'onboarding.chooser.title': 'Witaj w LinkCode',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'Jeśli LinkCode nie wykryje OpenCode automatycznie, ustaw ścieżkę binarki poniżej.',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Zapisuje do ustawień LinkCode i przeładowuje konfigurację OpenCode.',
  ...
  'onboarding.remoteConnection.description': 'Wpisz adres serwera LinkCode aby się połączyć.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'Sugestie: Zweryfikuj czy URL wskazuje na serwer LinkCode, lub skontaktuj się z administratorem serwera.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': 'Ta instancja używa innej wersji LinkCode. Możesz się połączyć, ale zaktualizuj obie aplikacje, jeśli coś nie działa.',
  'onboarding.remoteConnection.probe.incompatibleMessage': 'Serwer uruchamia LinkCode, ale nie jest zgodny z tą wersją aplikacji. Zaktualizuj LinkCode na serwerze i spróbuj ponownie.',
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'Serwer odpowiedział, ale nie uruchomiono na nim LinkCode. Zweryfikuj czy adres wskazuje na serwer LinkCode.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': 'Serwer pod adresem "{host}" nie uruchamia LinkCode. Zweryfikuj czy adres wskazuje na serwer LinkCode.',
  'onboarding.desktopRecovery.remoteIncompatible.title': 'Wymagana aktualizacja serwera',
  'onboarding.desktopRecovery.remoteIncompatible.description': 'Serwer LinkCode pod adresem "{host}" nie jest zgodny z tą wersją aplikacji. Zaktualizuj LinkCode na serwerze i spróbuj ponownie.',
  ...
  'startup.initRecovery.description': 'LinkCode nie mógł dokończyć inicjalizacji. Sprawdź czy serwer działa, następnie spróbuj ponownie.',
  ...
  'aboutDialog.diagnosticsDescription': 'Zawiera stan LinkCode, kondycję OpenCode, katalogi i projekty.',
  ...
  'aboutDialog.openChamberVersionLabel': 'Wersja LinkCode {version}',
  ...
  'contextPanel.browser.trustNotice': 'Strony otwierane tutaj działają z pełnym dostępem do LinkCode — jest to wymagane do inspekcji i zrzutów ekranu. Otwieraj tylko zaufane witryny: złośliwa strona może odczytać Twoje dane lub działać w Twoim imieniu.',
  ...
  'desktopHostSwitcher.description': 'Przełączaj między lokalnymi i zdalnymi serwerami LinkCode',
  ...
  'header.actions.openAppMenu': 'Menu LinkCode',
  'header.actions.openAppMenuAria': 'Otwórz menu LinkCode',
  ...
  'header.services.shutdownDev': 'Zatrzymaj LinkCode',
  ...
  'helpDialog.description': 'Użyj tych skrótów klawiaturowych, aby sprawnie poruszać się po LinkCode.',
  ...
  'sessionAuth.locked.unlockTitle': 'Odblokuj LinkCode',
  ...
  'updateDialog.header.updating': 'Aktualizowanie LinkCode...',
  ...
  'opencodeUpdate.toast.upgrading.description': 'Pozostaw LinkCode otwarte.',
  ...
  'onboarding.localSetup.intro': 'OpenCode to serce LinkCode — zainstaluj je, aby zacząć.',
