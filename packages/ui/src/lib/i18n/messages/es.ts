...
export const dict: Record<I18nKey, string> = {
  ...
  "pwa.installPrompt.description": "Instala LinkCode para acceder más rápido",
  "pwa.installPrompt.action": "Instalar",
  "pwa.installPrompt.dismiss": "Descartar",
  "pwa.installPrompt.started": "Instalación iniciada",
  "pwa.installPrompt.installed": "LinkCode se instaló",
  ...
  "sessions.sidebar.footer.actions.aboutOpenChamber": "Acerca de LinkCode",
  ...
  "contextPanel.browser.trustNotice": "Las páginas que abras aquí se ejecutan con acceso completo a LinkCode: necesario para la inspección y las capturas. Abre solo sitios de confianza: una página maliciosa podría leer tus datos o actuar en tu nombre.",
  ...
  "header.services.shutdownDev": "Detener LinkCode",
  ...
  "aboutDialog.openChamberVersionLabel": "Versión de LinkCode {version}",
  ...
  "aboutDialog.diagnosticsDescription": "Incluye el estado de LinkCode, el estado de OpenCode, directorios y proyectos.",
  ...
  "helpDialog.description": "Usa estos atajos de teclado para navegar por LinkCode de manera eficiente",
  ...
  "header.actions.openAppMenu": "Menú de LinkCode",
  "header.actions.openAppMenuAria": "Abrir menú de LinkCode",
  ...
  "sessionAuth.locked.unlockTitle": "Desbloquear LinkCode",
  ...
  "desktopHostSwitcher.description": "Cambia entre Local y el servidor remoto de LinkCode",
  ...
  "multiRun.window.description": "Ventana de LinkCode Multi-Run.",
  ...
  "onboarding.chooser.title": "Bienvenido a LinkCode",
  ...
  "onboarding.localSetup.windows.stepSetBinaryPath": "Si LinkCode no detecta OpenCode automáticamente, establece la ruta del ejecutable a continuación.",
  "onboarding.localSetup.intro": "OpenCode es el corazón de LinkCode. Instálalo para empezar.",
  ...
  "onboarding.localSetup.helper.saveAndReload": "Guarda en la configuración de LinkCode y recarga la configuración de OpenCode.",
  ...
  "onboarding.remoteConnection.description": "Introduce la dirección de un servidor de LinkCode para conectar.",
  ...
  "onboarding.remoteConnection.status.suggestionsWrongService": "Sugerencias: Verifica que la URL apunte a un servidor LinkCode o contacta al administrador del servidor.",
  ...
  "onboarding.remoteConnection.probe.updateRecommendedMessage": "Esta instancia ejecuta una versión diferente de LinkCode. Puedes conectarte, pero actualiza ambas apps si algo no funciona.",
  "onboarding.remoteConnection.probe.incompatibleMessage": "El servidor ejecuta LinkCode pero no es compatible con esta versión de la app. Actualiza LinkCode en el servidor y vuelve a intentarlo.",
  "onboarding.remoteConnection.probe.wrongServiceMessage": "El servidor respondió pero no está ejecutando LinkCode. Verifica que la dirección apunte a un servidor LinkCode.",
  ...
  "onboarding.desktopRecovery.incompatibleServer.description": "El servidor en \"{host}\" no está ejecutando LinkCode. Verifica que la dirección apunte a un servidor LinkCode.",
  "onboarding.desktopRecovery.remoteIncompatible.title": "Actualización del servidor requerida",
  "onboarding.desktopRecovery.remoteIncompatible.description": "El servidor LinkCode en \"{host}\" no es compatible con esta versión de la app. Actualiza LinkCode en el servidor y vuelve a intentarlo.",
  ...
  "startup.initRecovery.description": "LinkCode no pudo completar la inicialización. Comprueba que el servidor esté en ejecución y vuelve a intentarlo.",
  ...
  "updateDialog.header.updating": "Actualizando LinkCode...",
  ...
  "opencodeUpdate.toast.upgrading.description": "Mantén LinkCode abierto.",
  ...
  "openChamberLogo.aria.logo": "Logo de LinkCode",
