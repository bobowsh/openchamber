...
export const dict: Record<I18nKey, string> = {
  ...
  'pwa.installPrompt.description': '安裝 LinkCode 以便更快存取',
  'pwa.installPrompt.action': '安裝',
  'pwa.installPrompt.dismiss': '忽略',
  'pwa.installPrompt.started': '已開始安裝',
  'pwa.installPrompt.installed': 'LinkCode 已安裝',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': '此實例正在執行不同版本的 LinkCode。你可以連線；如果功能異常，請更新兩端應用程式。',
  'onboarding.remoteConnection.probe.incompatibleMessage': '伺服器正在執行 LinkCode，但與此應用程式版本不相容。請更新伺服器上的 LinkCode 後重試。',
  'onboarding.desktopRecovery.remoteIncompatible.title': '需要更新伺服器',
  'onboarding.desktopRecovery.remoteIncompatible.description': '「{host}」上的 LinkCode 伺服器與此應用程式版本不相容。請更新伺服器上的 LinkCode 後重試。',
  ...
  'sessions.sidebar.footer.actions.aboutOpenChamber': '關於 LinkCode',
  ...
  'contextPanel.mode.stagedDiff': '暫存差異',
  'contextPanel.mode.workingDiff': '工作區差異',
  ...
  'contextPanel.browser.trustNotice': '在此開啟的頁面以對 LinkCode 的完整存取權限執行 — 檢查與截圖需要此權限。僅開啟你信任的網站：惡意頁面可能讀取你的資料或以你的身分執行操作。',
  ...
  'aboutDialog.diagnosticsDescription': '包含 LinkCode 狀態、OpenCode 健康資訊、目錄和專案。',
  ...
  'helpDialog.description': '使用這些快速鍵可更有效率地導覽 LinkCode',
  ...
  'header.actions.openAppMenu': 'LinkCode 選單',
  'header.actions.openAppMenuAria': '開啟 LinkCode 選單',
  ...
  'chat.emptyState.draftTitle': '今天想做點什麼？',
  'chat.emptyState.draftTitleWithProject': '在 {project} 中想做點什麼？',
  'chat.draftPresets.explore.label': '探索程式碼庫',
  'chat.draftPresets.catchup.label': '了解最新進展',
  'chat.draftPresets.weigh.label': '權衡方案',
  'chat.draftPresets.plan.label': '開始功能規劃',
  'chat.draftPresets.debug.label': '調試問題',
  'chat.draftPresets.review.label': '審查變更',
  'chat.draftStarters.add': '新增入口',
  'chat.draftStarters.searchPlaceholder': '搜尋命令和技能…',
  'chat.draftStarters.empty': '沒有可新增的',
  ...
  'sessionAuth.locked.unlockTitle': '解鎖 LinkCode',
  ...
  'desktopHostSwitcher.description': '在 Local 與遠端 LinkCode 伺服器之間切換',
  ...
  'desktopHostSwitcher.instance.local': '本機',
  ...
  'multiRun.window.description': 'LinkCode 多執行視窗。',
  ...
  'onboarding.chooser.title': '歡迎使用 LinkCode',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': '如果 LinkCode 未自動偵測到 OpenCode，請在下方設定執行檔路徑。',
  'onboarding.localSetup.intro': 'OpenCode 是 LinkCode 的核心，先安裝它即可開始。',
  ...
  'onboarding.localSetup.helper.saveAndReload': '將儲存到 LinkCode 設定並重新載入 OpenCode 設定。',
  ...
  'onboarding.remoteConnection.description': '輸入要連接的 LinkCode 伺服器位址。',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': '建議：確認 URL 指向 LinkCode 伺服器，或聯絡伺服器管理員。',
  ...
  'onboarding.remoteConnection.probe.wrongServiceMessage': '伺服器有回應，但未執行 LinkCode。請確認位址是否指向 LinkCode 伺服器。',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': '「{host}」上的伺服器未執行 LinkCode。請確認位址是否指向 LinkCode 伺服器。',
  ...
  'startup.initRecovery.description': 'LinkCode 未能完成初始化。請檢查伺服器是否正在執行，然後重試。',
  ...
  'opencodeUpdate.toast.upgrading.description': '請保持 LinkCode 開啟。',
  ...
  'openChamberLogo.aria.logo': 'LinkCode 標誌',
  ...
  'contextFileOpen.failure.tooLarge': '檔案過大無法開啟（超過 {count} 行）',
  'contextFileOpen.failure.missing': '檔案未找到',
  'contextFileOpen.failure.unreadable': '開啟檔案失敗',
  'quota.window.5h': '5 小時',
  'quota.window.7d': '7 天限制',
  'quota.window.7dSonnet': '7 天 Sonnet 限制',
  'quota.window.7dOpus': '7 天 Opus 限制',
  'quota.window.weekly': '每週限制',
  'quota.window.daily': '每日',
  'quota.window.monthly': '每月限制',
  'quota.window.credits': '積分',
  'quota.window.creditsBalance': '積分餘額',
  'quota.window.billingCycle': '計費週期',
  'quota.window.auto': '自動',
  'quota.window.api': 'API',
  'quota.window.planLimit': '方案限制',
  'quota.window.onDemand': '按需',
  'quota.window.session': '會話',
  'quota.window.premium': '高級交互',
  'quota.window.chat': '聊天請求',
  'quota.window.completions': '補全',
  'quota.window.premiumInteractions': '高級交互',

  'tool.read': '讀取檔案',
  'tool.write': '寫入檔案',
  'tool.edit': '編輯檔案',
  'tool.multiedit': '批量編輯',
  'tool.applyPatch': '應用修補',
  'tool.list': '列出目錄',
  'tool.grep': '搜尋檔案',
  'tool.glob': '尋找檔案',
  'tool.bash': 'Shell 命令',
  ...
  'tool.planMode': '計劃模式',
  'tool.buildMode': '構建模式',
  'tool.structuredOutput': '結構化輸出',
  'tool.webfetch': '取得 URL',
  'tool.websearch': '網頁搜尋',
  'tool.codesearch': '程式碼搜尋',
};
